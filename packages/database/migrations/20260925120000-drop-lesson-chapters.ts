...
/**
 * lesson_chapters was created by an already-applied migration, so the
 * historical create migration remains in place. This follow-up removes the
 * obsolete persisted chapter table from existing and fresh databases.
 */
